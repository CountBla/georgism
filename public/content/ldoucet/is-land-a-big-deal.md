...
Let's carefully unpack what those terms means. "**Land value**" refers to the *rental value* of the land. This is the _recurring rental income_ of land/ground rent a property is capable of generating from the market. This is distinct but related to the lands *selling-price* or full market purchase price of the land _excluding_ all of its improvements, such as buildings. This is the portion of a property's price arising solely from its location and natural attributes (agricultural fertility, endowment of stuff like water, minerals, etc.).
